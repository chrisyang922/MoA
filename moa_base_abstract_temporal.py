...
def build_retrieved_prompt(query, profile_snippets, plan_text):
    ...
    instruction = (
        ...
        "These abstracts are ordered from MOST RECENT to OLDEST. "
        "Focus primarily on the most recent abstracts at the beginning of the list, "
        "as they best reflect the researcher's current tone, phrasing, and vocabulary. "
        "Maintain overall consistency with their general style but adapt most closely "
        "to how they write in the newest abstracts.\n\n"
